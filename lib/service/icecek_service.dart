...
class IcecekEkleService{
  ...
  var documentRef;
  //status eklemek için
  Future<IcecekBilgi> icecekEkle(String isim,String kategori,bool stok_durumu,bool alkol_durumu,double fiyat,String aciklama,XFile pickedFile) async {
    ...
    documentRef= await ref.add({'isim': isim,'kategori':kategori,'stok_durumu':stok_durumu,'alkol_durumu':alkol_durumu,'aciklama':aciklama, 'resim': mediaUrl,'fiyat':fiyat});

    return IcecekBilgi(kategori: kategori, isim: isim, alkol_durumu: alkol_durumu, stok_durumu: stok_durumu,aciklama: aciklama, fiyat: fiyat, resim: mediaUrl);
  }
